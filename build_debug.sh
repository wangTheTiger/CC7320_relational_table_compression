...
g++  -std=c++17 -g -I ~/include -L ~/lib retrieve_columns_bwt.cpp -o retrieve_columns_bwt -lsdsl -ldivsufsort -ldivsufsort64
g++  -std=c++17 -g -I ~/include -L ~/lib retrieve_columns_plain.cpp -o retrieve_columns_plain -lsdsl -ldivsufsort -ldivsufsort64